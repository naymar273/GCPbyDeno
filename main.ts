...
const envUUID = Deno.env.get('UUID') || '4283ef67-94ae-4ace-bbeb-7bf7b5bd4cb8';
const proxyIP = Deno.env.get('PROXYIP') || '';
const credit = Deno.env.get('CREDIT') || 'DenoBy-1011';
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Powered by Deno. For support, contact <a href="https://t.me/zero_1101_tg" target="_blank">@zero_1101_tg</a>.
        </div>
    </div>
</body>
</html>
